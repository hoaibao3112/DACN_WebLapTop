...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-gradient-to-r from-purple-500 to-pink-600 text-white hover:from-purple-600 hover:to-pink-700 focus:ring-purple-500 shadow-md hover:shadow-lg',
