        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Chuyên cung cấp laptop chính hãng, giá tốt nhất thị trường. Bảo hành chu đáo, hậu mãi tận tâm.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products?category=student" className="hover:text-blue-400 transition-colors">
                  Laptop Sinh viên
                </Link>
              </li>
            </ul>
