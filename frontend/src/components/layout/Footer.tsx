      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Laptop Shop</span>
            </div>
            <p className="text-sm mb-4 leading-relaxed">
              Chúng tôi cung cấp những giải pháp công nghệ hiện đại nhất, giúp nâng tầm trải nghiệm làm việc và giải trí của bạn.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products?category=gaming" className="hover:text-blue-400 transition-colors">
                  Laptop Gaming
                </Link>
              </li>
              <li>
                <Link href="/products?category=office" className="hover:text-blue-400 transition-colors">
                  MacBook
                </Link>
              </li>
              <li>
                <Link href="/products?category=graphics" className="hover:text-blue-400 transition-colors">
                  Phụ kiện công nghệ
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm">contact@laptopshop.vn</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <span className="text-sm">123 Đường Công Nghệ, Q.1, TP.HCM</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-center md:text-left">
            © {currentYear} Laptop Shop. Tất cả các quyền được bảo lưu.
          </p>
